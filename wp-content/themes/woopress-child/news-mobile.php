...
$wp_query->query("post_type=post&category_name=". $_GET['cat_name'] . "&showposts=15&paged=".$paged);
...
while ( have_posts() ) : the_post();
   ...
   ob_start();
      the_title('<p class="card-heading" style="text-transform:uppercase; font-weight:bold !important;">','</p>');
