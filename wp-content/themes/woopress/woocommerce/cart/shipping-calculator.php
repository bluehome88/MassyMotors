...
<h3 class="underlined"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></h3>

<div class="reference">
	<p><a href="#" class="default-link shipping-calculator-button">Click</a> here to calculate shipping fee, based on your location or shipping address.</p>
</div>
...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button big"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
