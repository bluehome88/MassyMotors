<div class="wrap bsf-page-wrapper">
	<div class="wrap-container">
	<div class="heading-section">
		<div class="wrap left-content-section">
		
			<h2><?php echo __('Geronimo!','ultimate_vc'); ?></h2>
			<p><?php  _e('Ultimate is now installed and you are ready to take your website design experience to the next level.','ultimate_vc'); ?></p>
            ...
            <div class="vc_col-sm-6 wpb_column vc_column_container ">
				<div class="bsf-wrap-content">
					...
					<div class="bsf-wrap-right-content">
						...
						<p class="ult-addon-discription"><?php echo __('We\'ve shipped about 360 useful icons that you can use in most of the Ultimate elements. However, should you wish to add any more - you can easily do that with the help of our popular Icon Font.','ultimate_vc'); ?></p>
					</div><!--bsf-wrap-right-content-->
				</div><!--bsf wrap content-->	
          	</div><!--vc_col-sm-6-->
