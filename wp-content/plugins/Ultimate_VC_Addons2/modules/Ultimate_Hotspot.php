	...
	class ULT_HotSpot {
		...
		function ult_hotspot_items_callback( $atts, $content = null ){
		  ...
		  if($tooltip_custom_border_size!=''){             
			...
			$output  = "<div class='ult-hotspot-item ".$pulse."' style='top:calc(".$hotspot_x_position."% - ".$temp_icon_size."px);left: calc(".$hotspot_y_position."% - ".$temp_icon_size."px);' >";
			$output .= "   <a ".$data." data-tooltip='".$content."' class='ult-tooltip tooltipstered cq-tooltip' href='#'>";
				$output .= $icon_inline;
			$output .= "  </a>";
			$output .= "</div>";
