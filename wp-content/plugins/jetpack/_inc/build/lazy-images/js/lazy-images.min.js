...
var jetpackLazyImagesModule=function(t){function e(){if(o=document.querySelectorAll("img[data-lazy-src]"),u=o.length,s&&s.disconnect(),"IntersectionObserver"in window)for(s=new IntersectionObserver(r,a),h=0;h<o.length;h++)c=o[h],c.getAttribute("data-lazy-loaded")||s.observe(c);else n(o)}function n(t){var e;for(e=0;e<t.length;e++){i(t[e])}}function r(t){var e;for(0===u&&s.disconnect(),e=0;e<t.length;e++){var n=t[e];n.intersectionRatio>0&&(u--,s.unobserve(n.target),i(n.target))}}function i(t){var e=t.getAttribute("data-lazy-src"),n=t.getAttribute("data-lazy-srcset"),r=t.getAttribute("data-lazy-sizes");e&&(t.classList&&t.classList.add("jetpack-lazy-image--handled"),t.setAttribute("data-lazy-loaded","1"),t.setAttribute("src",e),t.removeAttribute("data-lazy-src"),n&&(t.setAttribute("srcset",n),t.removeAttribute("data-lazy-srcset")),r&&(t.setAttribute("sizes",r),t.removeAttribute("data-lazy-sizes")))}var o,s,c,h,a={rootMargin:"200px 0px",threshold:.01},u=0;t(document).ready(function(){e(),t("body").bind("post-load",e)})};/**
